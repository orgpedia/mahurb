...
import/websites/gr.maharashtra.gov.in/Urban:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Urban .
...
import: check_env import/websites/gr.maharashtra.gov.in/Urban .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Urban import/documents
